  ...
  let listClienteConyuge = [
    {
      ...
      comment: 'Se sube el acta de matrimonio del cliente'
    },
    {
  ...
  return (
    <>
      ...
      <div className="accordion" id="accordionExample">
        ...
        <div className="accordion-item">
          <h2 className="accordion-header">
            <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOneB" aria-expanded="true" aria-controls="collapseOneB">
              Documentos del Conyuge del cliente
            </button>
          </h2>
          <div id="collapseOneB" className="accordion-collapse collapse show" data-bs-parent="#accordionExample">
            <div className="accordion-body">
