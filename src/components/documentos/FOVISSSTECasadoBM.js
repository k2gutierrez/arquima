...
export default function FOVISSSTECasadoBM(props) {
  ...
  let listCliente = [
    ...
    {
      title: 'Talon de pago 1',
      key: 'TalonesPagoCliente',
      text: 'Talon_Pago1_Cliente',
      comment: 'Se subió el primer talon de pago del cliente'
    },
    {
      title: 'Talon de pago 2',
      key: 'TalonesPagoCliente2',
      text: 'Talon_Pago2_Cliente',
      comment: 'Se subió el segundo talon de pago del cliente'
    },
    {
      title: 'Talon de pago 3',
      key: 'TalonesPagoCliente3',
      text: 'Talon_Pago3_Cliente',
      comment: 'Se subió el tercer talon de pago del cliente'
    },
    {
      title: 'Expediente electrónico único',
      key: 'ExpedienteElectronicoCliente',
      text: 'Expediente_electronico_Cliente',
      comment: 'Se subió el expediente electrónico único del cliente'
    },
  ]
